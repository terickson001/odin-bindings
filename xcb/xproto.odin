...
depth_sizeof                                                                                         :: proc(_buffer : rawptr) -> int ---;
depth_visuals_length                                                                                 :: proc(R : ^depth_t) -> int ---;
...
screen_sizeof                                                                                        :: proc(_buffer : rawptr) -> int ---;
screen_allowed_depths_length                                                                         :: proc(R : ^screen_t) -> int ---;
...
setup_request_sizeof                                                                                 :: proc(_buffer : rawptr) -> int ---;
setup_request_authorization_protocol_name_length                                                     :: proc(R : ^setup_request_t) -> int ---;
setup_request_authorization_protocol_name_end                                                        :: proc(R : ^setup_request_t) -> generic_iterator_t ---;
setup_request_authorization_protocol_data_length                                                     :: proc(R : ^setup_request_t) -> int ---;
...
setup_failed_sizeof                                                                                  :: proc(_buffer : rawptr) -> int ---;
setup_failed_reason_length                                                                           :: proc(R : ^setup_failed_t) -> int ---;
...
setup_authenticate_sizeof                                                                            :: proc(_buffer : rawptr) -> int ---;
setup_authenticate_reason_length                                                                     :: proc(R : ^setup_authenticate_t) -> int ---;
...
setup_sizeof                                                                                         :: proc(_buffer : rawptr) -> int ---;
setup_vendor_length                                                                                  :: proc(R : ^setup_t) -> int ---;
setup_vendor_end                                                                                     :: proc(R : ^setup_t) -> generic_iterator_t ---;
setup_pixmap_formats_length                                                                          :: proc(R : ^setup_t) -> int ---;
setup_pixmap_formats_iterator                                                                        :: proc(R : ^setup_t) -> format_iterator_t ---;
setup_roots_length                                                                                   :: proc(R : ^setup_t) -> int ---;
...
create_window_value_list_serialize                                                                   :: proc(_buffer : ^rawptr, value_mask : u32, _aux : ^create_window_value_list_t) -> int ---;
create_window_value_list_unpack                                                                      :: proc(_buffer : rawptr, value_mask : u32, _aux : ^create_window_value_list_t) -> int ---;
create_window_value_list_sizeof                                                                      :: proc(_buffer : rawptr, value_mask : u32) -> int ---;
create_window_sizeof                                                                                 :: proc(_buffer : rawptr) -> int ---;
...
change_window_attributes_value_list_serialize                                                        :: proc(_buffer : ^rawptr, value_mask : u32, _aux : ^change_window_attributes_value_list_t) -> int ---;
change_window_attributes_value_list_unpack                                                           :: proc(_buffer : rawptr, value_mask : u32, _aux : ^change_window_attributes_value_list_t) -> int ---;
change_window_attributes_value_list_sizeof                                                           :: proc(_buffer : rawptr, value_mask : u32) -> int ---;
change_window_attributes_sizeof                                                                      :: proc(_buffer : rawptr) -> int ---;
...
configure_window_value_list_serialize                                                                :: proc(_buffer : ^rawptr, value_mask : u16, _aux : ^configure_window_value_list_t) -> int ---;
configure_window_value_list_unpack                                                                   :: proc(_buffer : rawptr, value_mask : u16, _aux : ^configure_window_value_list_t) -> int ---;
configure_window_value_list_sizeof                                                                   :: proc(_buffer : rawptr, value_mask : u16) -> int ---;
configure_window_sizeof                                                                              :: proc(_buffer : rawptr) -> int ---;
...
query_tree_sizeof                                                                                    :: proc(_buffer : rawptr) -> int ---;
...
query_tree_children_length                                                                           :: proc(R : ^query_tree_reply_t) -> int ---;
query_tree_children_end                                                                              :: proc(R : ^query_tree_reply_t) -> generic_iterator_t ---;
intern_atom_sizeof                                                                                   :: proc(_buffer : rawptr) -> int ---;
...
get_atom_name_sizeof                                                                                 :: proc(_buffer : rawptr) -> int ---;
...
get_atom_name_name_length                                                                            :: proc(R : ^get_atom_name_reply_t) -> int ---;
get_atom_name_name_end                                                                               :: proc(R : ^get_atom_name_reply_t) -> generic_iterator_t ---;
change_property_sizeof                                                                               :: proc(_buffer : rawptr) -> int ---;
...
change_property_data_length                                                                          :: proc(R : ^change_property_request_t) -> int ---;
...
get_property_sizeof                                                                                  :: proc(_buffer : rawptr) -> int ---;
...
get_property_value_length                                                                            :: proc(R : ^get_property_reply_t) -> int ---;
get_property_value_end                                                                               :: proc(R : ^get_property_reply_t) -> generic_iterator_t ---;
list_properties_sizeof                                                                               :: proc(_buffer : rawptr) -> int ---;
...
list_properties_atoms_length                                                                         :: proc(R : ^list_properties_reply_t) -> int ---;
...
get_motion_events_sizeof                                                                             :: proc(_buffer : rawptr) -> int ---;
...
get_motion_events_events_length                                                                      :: proc(R : ^get_motion_events_reply_t) -> int ---;
...
open_font_sizeof                                                                                     :: proc(_buffer : rawptr) -> int ---;
...
open_font_name_length                                                                                :: proc(R : ^open_font_request_t) -> int ---;
...
query_font_sizeof                                                                                    :: proc(_buffer : rawptr) -> int ---;
...
query_font_properties_length                                                                         :: proc(R : ^query_font_reply_t) -> int ---;
query_font_properties_iterator                                                                       :: proc(R : ^query_font_reply_t) -> fontprop_iterator_t ---;
query_font_char_infos_length                                                                         :: proc(R : ^query_font_reply_t) -> int ---;
query_font_char_infos_iterator                                                                       :: proc(R : ^query_font_reply_t) -> charinfo_iterator_t ---;
query_text_extents_sizeof                                                                            :: proc(_buffer : rawptr, string_len : u32) -> int ---;
...
str_sizeof                                                                                           :: proc(_buffer : rawptr) -> int ---;
str_name_length                                                                                      :: proc(R : ^str_t) -> int ---;
...
list_fonts_sizeof                                                                                    :: proc(_buffer : rawptr) -> int ---;
...
list_fonts_names_length                                                                              :: proc(R : ^list_fonts_reply_t) -> int ---;
list_fonts_names_iterator                                                                            :: proc(R : ^list_fonts_reply_t) -> str_iterator_t ---;
list_fonts_with_info_sizeof                                                                          :: proc(_buffer : rawptr) -> int ---;
...
list_fonts_with_info_properties_length                                                               :: proc(R : ^list_fonts_with_info_reply_t) -> int ---;
list_fonts_with_info_properties_iterator                                                             :: proc(R : ^list_fonts_with_info_reply_t) -> fontprop_iterator_t ---;
list_fonts_with_info_name_length                                                                     :: proc(R : ^list_fonts_with_info_reply_t) -> int ---;
list_fonts_with_info_name_end                                                                        :: proc(R : ^list_fonts_with_info_reply_t) -> generic_iterator_t ---;
set_font_path_sizeof                                                                                 :: proc(_buffer : rawptr) -> int ---;
...
set_font_path_font_length                                                                            :: proc(R : ^set_font_path_request_t) -> int ---;
set_font_path_font_iterator                                                                          :: proc(R : ^set_font_path_request_t) -> str_iterator_t ---;
get_font_path_sizeof                                                                                 :: proc(_buffer : rawptr) -> int ---;
...
get_font_path_path_length                                                                            :: proc(R : ^get_font_path_reply_t) -> int ---;
...
create_gc_value_list_serialize                                                                       :: proc(_buffer : ^rawptr, value_mask : u32, _aux : ^create_gc_value_list_t) -> int ---;
create_gc_value_list_unpack                                                                          :: proc(_buffer : rawptr, value_mask : u32, _aux : ^create_gc_value_list_t) -> int ---;
create_gc_value_list_sizeof                                                                          :: proc(_buffer : rawptr, value_mask : u32) -> int ---;
create_gc_sizeof                                                                                     :: proc(_buffer : rawptr) -> int ---;
...
change_gc_value_list_serialize                                                                       :: proc(_buffer : ^rawptr, value_mask : u32, _aux : ^change_gc_value_list_t) -> int ---;
change_gc_value_list_unpack                                                                          :: proc(_buffer : rawptr, value_mask : u32, _aux : ^change_gc_value_list_t) -> int ---;
change_gc_value_list_sizeof                                                                          :: proc(_buffer : rawptr, value_mask : u32) -> int ---;
change_gc_sizeof                                                                                     :: proc(_buffer : rawptr) -> int ---;
...
set_dashes_sizeof                                                                                    :: proc(_buffer : rawptr) -> int ---;
...
set_dashes_dashes_length                                                                             :: proc(R : ^set_dashes_request_t) -> int ---;
set_dashes_dashes_end                                                                                :: proc(R : ^set_dashes_request_t) -> generic_iterator_t ---;
set_clip_rectangles_sizeof                                                                           :: proc(_buffer : rawptr, rectangles_len : u32) -> int ---;
...
set_clip_rectangles_rectangles_length                                                                :: proc(R : ^set_clip_rectangles_request_t) -> int ---;
...
poly_point_sizeof                                                                                    :: proc(_buffer : rawptr, points_len : u32) -> int ---;
...
poly_point_points_length                                                                             :: proc(R : ^poly_point_request_t) -> int ---;
poly_point_points_iterator                                                                           :: proc(R : ^poly_point_request_t) -> point_iterator_t ---;
poly_line_sizeof                                                                                     :: proc(_buffer : rawptr, points_len : u32) -> int ---;
...
poly_line_points_length                                                                              :: proc(R : ^poly_line_request_t) -> int ---;
...
poly_segment_sizeof                                                                                  :: proc(_buffer : rawptr, segments_len : u32) -> int ---;
...
poly_segment_segments_length                                                                         :: proc(R : ^poly_segment_request_t) -> int ---;
poly_segment_segments_iterator                                                                       :: proc(R : ^poly_segment_request_t) -> segment_iterator_t ---;
poly_rectangle_sizeof                                                                                :: proc(_buffer : rawptr, rectangles_len : u32) -> int ---;
...
poly_rectangle_rectangles_length                                                                     :: proc(R : ^poly_rectangle_request_t) -> int ---;
poly_rectangle_rectangles_iterator                                                                   :: proc(R : ^poly_rectangle_request_t) -> rectangle_iterator_t ---;
poly_arc_sizeof                                                                                      :: proc(_buffer : rawptr, arcs_len : u32) -> int ---;
...
poly_arc_arcs_length                                                                                 :: proc(R : ^poly_arc_request_t) -> int ---;
poly_arc_arcs_iterator                                                                               :: proc(R : ^poly_arc_request_t) -> arc_iterator_t ---;
fill_poly_sizeof                                                                                     :: proc(_buffer : rawptr, points_len : u32) -> int ---;
...
fill_poly_points_length                                                                              :: proc(R : ^fill_poly_request_t) -> int ---;
fill_poly_points_iterator                                                                            :: proc(R : ^fill_poly_request_t) -> point_iterator_t ---;
poly_fill_rectangle_sizeof                                                                           :: proc(_buffer : rawptr, rectangles_len : u32) -> int ---;
...
poly_fill_rectangle_rectangles_length                                                                :: proc(R : ^poly_fill_rectangle_request_t) -> int ---;
poly_fill_rectangle_rectangles_iterator                                                              :: proc(R : ^poly_fill_rectangle_request_t) -> rectangle_iterator_t ---;
poly_fill_arc_sizeof                                                                                 :: proc(_buffer : rawptr, arcs_len : u32) -> int ---;
...
poly_fill_arc_arcs_length                                                                            :: proc(R : ^poly_fill_arc_request_t) -> int ---;
poly_fill_arc_arcs_iterator                                                                          :: proc(R : ^poly_fill_arc_request_t) -> arc_iterator_t ---;
put_image_sizeof                                                                                     :: proc(_buffer : rawptr, data_len : u32) -> int ---;
...
put_image_data_length                                                                                :: proc(R : ^put_image_request_t) -> int ---;
put_image_data_end                                                                                   :: proc(R : ^put_image_request_t) -> generic_iterator_t ---;
get_image_sizeof                                                                                     :: proc(_buffer : rawptr) -> int ---;
...
get_image_data_length                                                                                :: proc(R : ^get_image_reply_t) -> int ---;
get_image_data_end                                                                                   :: proc(R : ^get_image_reply_t) -> generic_iterator_t ---;
poly_text_8_sizeof                                                                                   :: proc(_buffer : rawptr, items_len : u32) -> int ---;
...
poly_text_8_items_length                                                                             :: proc(R : ^poly_text_8_request_t) -> int ---;
poly_text_8_items_end                                                                                :: proc(R : ^poly_text_8_request_t) -> generic_iterator_t ---;
poly_text_16_sizeof                                                                                  :: proc(_buffer : rawptr, items_len : u32) -> int ---;
...
poly_text_16_items_length                                                                            :: proc(R : ^poly_text_16_request_t) -> int ---;
poly_text_16_items_end                                                                               :: proc(R : ^poly_text_16_request_t) -> generic_iterator_t ---;
image_text_8_sizeof                                                                                  :: proc(_buffer : rawptr) -> int ---;
...
image_text_8_string_length                                                                           :: proc(R : ^image_text_8_request_t) -> int ---;
image_text_8_string_end                                                                              :: proc(R : ^image_text_8_request_t) -> generic_iterator_t ---;
image_text_16_sizeof                                                                                 :: proc(_buffer : rawptr) -> int ---;
...
image_text_16_string_length                                                                          :: proc(R : ^image_text_16_request_t) -> int ---;
...
list_installed_colormaps_sizeof                                                                      :: proc(_buffer : rawptr) -> int ---;
...
list_installed_colormaps_cmaps_length                                                                :: proc(R : ^list_installed_colormaps_reply_t) -> int ---;
...
alloc_named_color_sizeof                                                                             :: proc(_buffer : rawptr) -> int ---;
...
alloc_color_cells_sizeof                                                                             :: proc(_buffer : rawptr) -> int ---;
...
alloc_color_cells_pixels_length                                                                      :: proc(R : ^alloc_color_cells_reply_t) -> int ---;
alloc_color_cells_pixels_end                                                                         :: proc(R : ^alloc_color_cells_reply_t) -> generic_iterator_t ---;
alloc_color_cells_masks_length                                                                       :: proc(R : ^alloc_color_cells_reply_t) -> int ---;
alloc_color_cells_masks_end                                                                          :: proc(R : ^alloc_color_cells_reply_t) -> generic_iterator_t ---;
alloc_color_planes_sizeof                                                                            :: proc(_buffer : rawptr) -> int ---;
...
alloc_color_planes_pixels_length                                                                     :: proc(R : ^alloc_color_planes_reply_t) -> int ---;
alloc_color_planes_pixels_end                                                                        :: proc(R : ^alloc_color_planes_reply_t) -> generic_iterator_t ---;
free_colors_sizeof                                                                                   :: proc(_buffer : rawptr, pixels_len : u32) -> int ---;
...
free_colors_pixels_length                                                                            :: proc(R : ^free_colors_request_t) -> int ---;
...
store_colors_sizeof                                                                                  :: proc(_buffer : rawptr, items_len : u32) -> int ---;
...
store_colors_items_length                                                                            :: proc(R : ^store_colors_request_t) -> int ---;
store_colors_items_iterator                                                                          :: proc(R : ^store_colors_request_t) -> coloritem_iterator_t ---;
store_named_color_sizeof                                                                             :: proc(_buffer : rawptr) -> int ---;
...
store_named_color_name_length                                                                        :: proc(R : ^store_named_color_request_t) -> int ---;
...
query_colors_sizeof                                                                                  :: proc(_buffer : rawptr, pixels_len : u32) -> int ---;
...
query_colors_colors_length                                                                           :: proc(R : ^query_colors_reply_t) -> int ---;
query_colors_colors_iterator                                                                         :: proc(R : ^query_colors_reply_t) -> rgb_iterator_t ---;
lookup_color_sizeof                                                                                  :: proc(_buffer : rawptr) -> int ---;
...
query_extension_sizeof                                                                               :: proc(_buffer : rawptr) -> int ---;
...
list_extensions_sizeof                                                                               :: proc(_buffer : rawptr) -> int ---;
...
list_extensions_names_length                                                                         :: proc(R : ^list_extensions_reply_t) -> int ---;
list_extensions_names_iterator                                                                       :: proc(R : ^list_extensions_reply_t) -> str_iterator_t ---;
change_keyboard_mapping_sizeof                                                                       :: proc(_buffer : rawptr) -> int ---;
...
change_keyboard_mapping_keysyms_length                                                               :: proc(R : ^change_keyboard_mapping_request_t) -> int ---;
change_keyboard_mapping_keysyms_end                                                                  :: proc(R : ^change_keyboard_mapping_request_t) -> generic_iterator_t ---;
get_keyboard_mapping_sizeof                                                                          :: proc(_buffer : rawptr) -> int ---;
...
get_keyboard_mapping_keysyms_length                                                                  :: proc(R : ^get_keyboard_mapping_reply_t) -> int ---;
get_keyboard_mapping_keysyms_end                                                                     :: proc(R : ^get_keyboard_mapping_reply_t) -> generic_iterator_t ---;
change_keyboard_control_value_list_serialize                                                         :: proc(_buffer : ^rawptr, value_mask : u32, _aux : ^change_keyboard_control_value_list_t) -> int ---;
change_keyboard_control_value_list_unpack                                                            :: proc(_buffer : rawptr, value_mask : u32, _aux : ^change_keyboard_control_value_list_t) -> int ---;
change_keyboard_control_value_list_sizeof                                                            :: proc(_buffer : rawptr, value_mask : u32) -> int ---;
change_keyboard_control_sizeof                                                                       :: proc(_buffer : rawptr) -> int ---;
...
change_hosts_sizeof                                                                                  :: proc(_buffer : rawptr) -> int ---;
...
change_hosts_address_length                                                                          :: proc(R : ^change_hosts_request_t) -> int ---;
change_hosts_address_end                                                                             :: proc(R : ^change_hosts_request_t) -> generic_iterator_t ---;
host_sizeof                                                                                          :: proc(_buffer : rawptr) -> int ---;
host_address_length                                                                                  :: proc(R : ^host_t) -> int ---;
...
rotate_properties_sizeof                                                                             :: proc(_buffer : rawptr) -> int ---;
...
rotate_properties_atoms_length                                                                       :: proc(R : ^rotate_properties_request_t) -> int ---;
...
set_pointer_mapping_sizeof                                                                           :: proc(_buffer : rawptr) -> int ---;
...
get_pointer_mapping_sizeof                                                                           :: proc(_buffer : rawptr) -> int ---;
...
get_pointer_mapping_map_length                                                                       :: proc(R : ^get_pointer_mapping_reply_t) -> int ---;
get_pointer_mapping_map_end                                                                          :: proc(R : ^get_pointer_mapping_reply_t) -> generic_iterator_t ---;
set_modifier_mapping_sizeof                                                                          :: proc(_buffer : rawptr) -> int ---;
...
get_modifier_mapping_sizeof                                                                          :: proc(_buffer : rawptr) -> int ---;
...
get_modifier_mapping_keycodes_length                                                                 :: proc(R : ^get_modifier_mapping_reply_t) -> int ---;
